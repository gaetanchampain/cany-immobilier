...
(function () {
  ...
  const FR_TO_EN = {
    ...
    "Générations dans le métier": "Generations in the trade",
    "Revues nationales spécialisées": "Specialised national magazines",
    "Plusieurs": "Several",
    "centaines": "hundreds",
    "de demeures sont passées entre nos mains depuis 1997. Voici un aperçu — pour donner la mesure du genre de pierres avec lesquelles nous travaillons.":
      "of estates have passed through our hands since 1997. Here is a glimpse — to give a sense of the kind of stone we work with.",
    ...
    "Nouveautés": "Latest",
    "✦ Une autre manière de communiquer": "✦ A different way of communicating",
    "Une presse": "A chosen",
    "choisie,": "press,",
    "des visites sélectionnées.": "selected visits.",
    "Nos demeures paraissent dans": "Our estates appear in",
    "et": "and",
    "— jamais sur les portails gratuits. Et chaque visite est filtrée par la famille, en amont.":
      "— never on free portals. And every visit is filtered by the family, beforehand.",
    "Nous confier votre demeure": "Entrust us with your estate",
    ...
    "villa d'artistes": "artists' villa",
    "face aux falaises d'Étretat.": "facing the cliffs of Étretat.",
    "La Villa Chantoiseau, grande demeure d'artistes de huit pièces et 240 m², occupe l'un des plus beaux points de vue sur la mer et sur les falaises mythiques d'Étretat — l'une des plus belles vues que l'agence ait rencontrées en 27 ans, selon la fiche officielle. Les pièces de réception baignent toute la journée dans la lumière particulière de la Côte d'Albâtre, celle qui a fait peindre Monet à quelques kilomètres d'ici.":
      "Villa Chantoiseau, a grand artists' residence of eight rooms and 240 m², occupies one of the most beautiful viewpoints over the sea and the legendary cliffs of Étretat — one of the finest views the agency has encountered in 27 years, according to the official listing. The reception rooms bathe all day in the particular light of the Alabaster Coast, the one that drew Monet to paint just a few kilometres from here.",
    "Distribuée sur quatre niveaux, la villa offre au rez-de-chaussée une entrée, une salle à manger avec cheminée de 30 m², une chambre de 17 m² avec cabinet de toilette, une cuisine de 13 m² et un wc séparé. Les étages se déploient en suite : deux grandes chambres de 27 et 30 m² au premier, deux autres de 21 et 30 m² au deuxième, et deux chambres mansardées au troisième sous les toits.":
      "Distributed across four floors, the villa offers on the ground floor an entrance, a 30 m² dining room with fireplace, a 17 m² bedroom with private cloakroom, a 13 m² kitchen and a separate toilet. The upper floors unfold in succession: two large bedrooms of 27 and 30 m² on the first floor, two others of 27 and 30 m² on the second, and two attic bedrooms under the eaves on the third.",
    "« Probablement l'une des plus belles vues sur la mer et sur les falaises d'Étretat que nous ayons vues en vingt-sept ans. »":
      "\"Probably one of the most beautiful views over the sea and over the cliffs of Étretat we have seen in twenty-seven years.\"",
    "Le tout sur un terrain clos de 1 430 m². Taxe foncière 1 740 € par an. Diagnostic énergétique réalisé en 2024 (G/G), signalant un bâti d'époque dont la consommation reflète les standards d'origine — un point à intégrer dans tout projet de rénovation, comme souvent pour les villas de cette générosité.":
      "All on a walled plot of 1,430 m². Property tax €1,740 per year. Energy assessment carried out in 2024 (G/G), reflecting the standards of a period building — a point to factor into any renovation project, as is often the case for villas of this scale.",
    "L'essentiel": "The essentials",
    "de la villa.": "of the villa.",
    "Sur les falaises d'Étretat": "Over the cliffs of Étretat",
    "Villa d'artistes": "Artists' villa",
    "240 m² habitables, 8 pièces": "240 m² living, 8 rooms",
    "Distribution sur 4 niveaux": "Distributed across 4 floors",
    "Salle à manger 30 m² avec cheminée": "30 m² dining room with fireplace",
    "Sept chambres": "Seven bedrooms",
    "De 11 à 30 m², deux étages principaux": "From 11 to 30 m², two main floors",
    "Jardin clos de murs": "Walled garden",
    "1 430 m² de terrain": "1,430 m² of land",
    "Cuisine": "Kitchen",
    "13 m², au rez-de-chaussée": "13 m², on the ground floor",
    "Honoraires charge vendeur": "Fees paid by seller",
    "4,11 % inclus": "4.11% included",
    ...
    "XIX<sup>e</sup> siècle": "19th century",
    "Période": "Period",
    ...
    "· Honoraires charge vendeur · 4,11 % inclus":
      "· Fees paid by seller · 4.11% included",
    ...
    "du premier rendez-vous": "from the first meeting",
    "à la signature.": "to the signing.",
    "Pas de relais, pas de transferts, pas d'algorithme. La même personne — Jean-Charles, Patricia ou Louis — vous accompagne de l'estimation à l'acte authentique chez le notaire. C'est ce qui distingue une agence familiale des chaînes de mandats partagés.":
      "No handovers, no transfers, no algorithm. The same person — Jean-Charles, Patricia or Louis — accompanies you from the valuation to the final deed at the notary. This is what distinguishes a family agency from chains of shared mandates.",
